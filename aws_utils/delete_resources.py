...
instances = ec2.create_instances(
    ImageId='ami-0c7217cdde317cfec', InstanceType='t2.nano', MaxCount=1, MinCount=1, KeyName='controller_keypair',
...
with open(SETUP_DIR+'/controller_ip.txt', 'w+') as f:
    f.write(ip_address+'\n')
f.close()

bashCommand = "scp -i controller_keypair.pem SETUP_DIR/common.* ubuntu@"+ip_address+":/home/ubuntu/"
os.system(bashCommand)
